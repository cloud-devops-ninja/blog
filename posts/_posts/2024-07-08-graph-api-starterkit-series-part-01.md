---
layout: post
title:  "The Graph API StarterKit for AVD and Windows 365 automation: introduction"
date:   2024-07-10 12:00:00 +0100
authors: [cdo-ninja]
image: assets/images/posts/graph-api-logo.png
tags: [blog]
hidden: false
toc: false
---

# The Graph API StarterKit for AVD & Windows365 automation series

This Graph API StarterKit for AVD & Windows365 automation blog series gives you an insight into my personal approach to automating Azure Virtual Desktop and Windows 365 CloudPC administrative tasks. After zooming in on the differences between AVD and Windows365 automation, I will give you detailed examples of how I use Postman to test API calls and use basic scripts and variables to re-use data, like access tokens and ids. And I'll also share my structured approach to translate basic workflows administrative IT processes into reusable PowerShell scripts to automate common tasks \
&nbsp;
&nbsp;

## The End User Computing (EUC) evolution

The introduction of Cloud services did not impact the End User Computing (EUC) industry that much as virtual desktops and working remotely still had limited use cases and was mostly focused on providing the end user access to a Virtual Desktop Infrastructure hosted in an on-premises data center. It did however gave me a great example to explain the concept of remote working with streaming services becoming mainstream. By using Netflix as an example it became easier to explain how the end user could simply log onto a web portal, select the business application they wanted to use and have it streamed to their PC (without leaving data on the endpoint when the application was closed) \
&nbsp;
&nbsp;
